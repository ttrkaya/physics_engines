package com.ttrkaya.t2d.test
{
	...
	internal class T2TestLineIntersectionInfinite extends Sprite
	{
		private var line0:T2Line;
		private var line1:T2Line;
		
		public function T2TestLineIntersectionInfinite()
		{
		...
		private function onEnterFrame(e:Event):void
		{
			...
			var doesCollide:Boolean = line0.collidesWithInfiniteLine(line1);
			...
			var collisionPoint:T2Vec = line0.getCollisionPointWithInfiniteLine(line1);
			if(collisionPoint)
			{
